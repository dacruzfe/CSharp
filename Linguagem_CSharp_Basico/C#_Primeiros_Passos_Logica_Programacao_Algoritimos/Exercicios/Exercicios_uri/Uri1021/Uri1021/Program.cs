...
namespace Uri1021
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Primeiro passo é Multiplicar N por 100 e forçar a conversão para int.
            // desse modo, por exemplo, 576.73 vai ficar 57673

            // Agora vamos somar 0.5 antes de converter, para assegurar
            // que o numero seja devidamente arredondado, pois o tipo double
            // as vezes da problema no arredondamento (por exemplo: se eu digitar
            // 576.81 e multiplicar por 100, o resultado sera 57680.99999999,
            // dai o casting resultaria em 57680 e não 57681 como desejado)
